...
class PaginationUtils {
     ...
     */
    static buildSortObject(sortBy = DEFAULT_SORT_BY, sortOrder = DEFAULT_SORT_ORDER, validSortFields = []) {
        const finalSortBy = validSortFields.includes(sortBy) ? sortBy : DEFAULT_SORT_BY;
        const finalSortOrder = (sortOrder && ['asc', 'desc'].includes(sortOrder.toLowerCase())) 
